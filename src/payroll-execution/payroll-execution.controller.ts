...
// payroll-execution/payroll-execution.controller.ts
...
export class PayrollExecutionController {
  constructor(
    ...
    private readonly phase1BService: PayrollPhase1_1BService,  // <-- NEW
  ...
  // ============================================
  // Requirement #2 — Edit Payroll Initiation Period
  // ============================================
  ...
  // ============================================
  // Requirement #3 — Start Automatic Payroll Initiation
  // ============================================
  @Post('phase1/start')
  startPayrollInitiation(
    @Body() dto: StartPayrollRunDto,
  ) {
    return this.payrollExecutionService.startPayrollInitiation(dto);
  }

  // ============================================
  // Phase 1.1 — Payroll Draft
  // ============================================
  @Post('generate-draft')
  ...
  // ============================================
  // Phase 1.1.B — Apply Penalties & Finalize Deductions
  // ============================================
