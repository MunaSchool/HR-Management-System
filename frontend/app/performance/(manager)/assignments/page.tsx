  ...
  const filterAssignments = () => {
    ...
    if (searchTerm) {
      ...
      filtered = filtered.filter(assignment => {
        const employeeName = typeof assignment.employeeProfileId === 'object' && 'firstName' in assignment.employeeProfileId
          ? `${assignment.employeeProfileId.firstName} ${assignment.employeeProfileId.lastName}`.toLowerCase()
          : '';
                      ...
                      <div className="flex items-center justify-between mb-2">
                        <div>
                          ...
                          <p className="text-sm text-gray-500">
                            {typeof assignment.employeeProfileId === 'object' && 'position' in assignment.employeeProfileId
