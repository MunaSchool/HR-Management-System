...
export default function ViewCyclePage() {
  ...
  const getAssignmentStats = () => {
    ...
    const completed = assignments.filter(a => a.status === AppraisalAssignmentStatus.PUBLISHED || 
                                                a.status === AppraisalAssignmentStatus.ACKNOWLEDGED).length;
    const inProgress = assignments.filter(a => a.status === AppraisalAssignmentStatus.IN_PROGRESS || 
                                                 a.status === AppraisalAssignmentStatus.SUBMITTED).length;
  ...
  if (!cycle) {
    return (
      <div className="text-center py-12">
        ...
        <h2 className="text-xl font-bold text-gray-900 mb-2">Cycle Not Found</h2>
        <p className="text-gray-600 mb-6">The cycle you're looking for doesn't exist or has been deleted.</p>
        ...
        <div className="lg:col-span-2 space-y-6">
            ...
            <div className="space-y-4">
              ...
              {cycle.managerDueDate && (
                <div className="flex items-center justify-between p-3 bg-yellow-50 rounded-lg">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <p className="text-sm text-gray-600">Manager Due Date</p>
                      <p className="font-medium">
              ...
              {cycle.employeeAcknowledgementDueDate && (
                <div className="flex items-center justify-between p-3 bg-green-50 rounded-lg">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <p className="text-sm text-gray-600">Employee Acknowledgement Due</p>
                      <p className="font-medium">
              ...
              <div className="p-3 bg-gray-50 rounded-lg">
                <p className="text-sm text-gray-600">
                  Duration: {Math.ceil((new Date(cycle.endDate).getTime() - new Date(cycle.startDate).getTime()) / (1000 * 60 * 60 * 24))} days
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white border rounded-lg p-6 shadow-sm">
            <div className="flex justify-between items-center mb-6">
              <h3 className="font-medium text-gray-900">Template Assignments</h3>
            ...
            {(!cycle.templateAssignments || cycle.templateAssignments.length === 0) ? (
              <div className="text-center py-8 border rounded-lg bg-gray-50">
                ...
                <p className="text-gray-500">No template assignments for this cycle.</p>
              </div>
            ) : (
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex items-start gap-3 flex-1">
                        ...
                        <div className="flex-1">
                          <h4 className="font-medium text-gray-900">Template ID: {assignment.templateId}</h4>
                          <div className="mt-2">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white border rounded-lg p-6 shadow-sm">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="font-medium text-gray-900">Assignment Statistics</h3>
            </div>
          ...
          {/* Cycle Actions */}
          <div className="bg-white border rounded-lg p-6 shadow-sm">
            <h3 className="font-medium text-gray-900 mb-4">Cycle Management</h3>
          ...
          {/* Cycle Info */}
          <div className="bg-white border rounded-lg p-6 shadow-sm">
            <h3 className="font-medium text-gray-900 mb-4">Cycle Information</h3>
            <div className="space-y-3">
