...
export default function AnalyticsPage() {
  ...
  const exportReport = async () => {
    try {
      const data = await performanceApi.exportPerformanceReport(timeframe === 'current' ? undefined : timeframe);
  ...
  return (
    <div className="space-y-6">
      ...
      {viewMode === 'overview' && (
        <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                <div>
                  <div className="flex justify-between text-sm mb-1">
                    ...
                    <span className="font-medium">{analytics?.completedAssignments || 0}</span>
                  </div>
                  <div className="w-full bg-gray-200 rounded-full h-2">
                    <div 
                      className="bg-green-600 h-2 rounded-full" 
                      style={{ 
                        width: `${(analytics?.completedAssignments || 0) / (analytics?.totalAssignments || 1) * 100}%` 
                      }}
                    ></div>
                  </div>
                </div>
                <div>
                  <div className="flex justify-between text-sm mb-1">
                    ...
                    <span className="font-medium">{analytics?.inProgressAssignments || 0}</span>
                  </div>
                  <div className="w-full bg-gray-200 rounded-full h-2">
                    <div 
                      className="bg-yellow-600 h-2 rounded-full" 
                      style={{ 
                        width: `${(analytics?.inProgressAssignments || 0) / (analytics?.totalAssignments || 1) * 100}%` 
                      }}
                    ></div>
                  </div>
                </div>
                <div>
                  <div className="flex justify-between text-sm mb-1">
                    ...
                    <span className="font-medium">{analytics?.notStartedAssignments || 0}</span>
                  </div>
                  <div className="w-full bg-gray-200 rounded-full h-2">
                    <div 
                      className="bg-gray-400 h-2 rounded-full" 
                      style={{ 
                        width: `${(analytics?.notStartedAssignments || 0) / (analytics?.totalAssignments || 1) * 100}%` 
                      }}
                    ></div>
                  </div>
                </div>
            ...
            <div className="bg-white border rounded-lg p-6 shadow-sm">
              <h3 className="font-medium text-gray-900 mb-4">Quick Insights</h3>
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <span className="text-sm text-gray-600">Total Records</span>
                  <span className="text-sm font-medium">{analytics?.totalRecords || 0}</span>
                </div>
                <div className="flex items-center justify-between">
                ...
                <div className="pt-3 border-t">
                  <p className="text-xs text-gray-500">
                    Based on {analytics?.totalAssignments || 0} total assignments across all departments.
                  </p>
                </div>
              </div>
            </div>
      ...
      {viewMode === 'trends' && (
        <div className="bg-white border rounded-lg p-6 shadow-sm">
          <h3 className="font-medium text-gray-900 mb-4">Performance Trends Over Time</h3>
          ...
          <div className="mt-4 grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="text-center p-4 bg-blue-50 rounded-md">
              ...
              <p className="text-sm text-gray-600">Completion Rate Trend</p>
            </div>
            ...
            <div className="text-center p-4 bg-yellow-50 rounded-md">
              <p className="text-2xl font-bold text-yellow-600">3.2 days</p>
            ...
            <table className="min-w-full divide-y divide-gray-200">
              ...
              <tbody className="divide-y divide-gray-200">
                ...
                <tr>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-green-600 font-medium">84%</td>
                ...
                <tr>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-yellow-600 font-medium">79%</td>
                ...
                <tr>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-yellow-600 font-medium">78%</td>
                ...
                <tr>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-green-600 font-medium">83%</td>
      ...
      {viewMode === 'detailed' && (
        <div className="bg-white border rounded-lg p-6 shadow-sm">
          <h3 className="font-medium text-gray-900 mb-4">Detailed Analytics</h3>
          <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="p-4 bg-blue-50 rounded-md">
                <h4 className="font-medium text-blue-800 mb-2">Timeline Analysis</h4>
              ...
              <div className="p-4 bg-green-50 rounded-md">
                <h4 className="font-medium text-green-800 mb-2">Score Distribution</h4>
              ...
              <div className="p-4 bg-purple-50 rounded-md">
                <h4 className="font-medium text-purple-800 mb-2">Participation</h4>
            ...
            <div className="border-t pt-4">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li className="flex items-start">
                  ...
                  <span>Increase focus on departments with completion rates below 75%</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="h-4 w-4 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
                  <span>Provide additional training for managers with low participation rates</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="h-4 w-4 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
                  <span>Consider shortening evaluation cycles to improve completion times</span>
                </li>
              </ul>
            </div>
          </div>
